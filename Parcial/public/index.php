...
$app->get('/registro', function(Request $request, Response $response, array $args){
    $view = Twig::fromRequest($request);
    $listadoPerfiles = Perfil::TraerTodosPerfiles();
    return $view->render($response, 'registro.php', ['listadoPerfiles' => $listadoPerfiles->listado]);
});

$app->get('/principal', function(Request $request, Response $response, array $args){
    $view = Twig::fromRequest($request);
    $listadoPerfiles = Perfil::TraerTodosPerfiles();
    return $view->render($response, 'principal.php', ['listadoPerfiles' => $listadoPerfiles->listado]);
});
